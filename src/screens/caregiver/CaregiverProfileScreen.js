/**
 * CaregiverProfileScreen - Caregiver Profile Screen
 *
 * Displays caregiver user profile information and provides access to profile editing.
 */
...
/**
 * CaregiverProfileScreen Component
 *
      ...
      <View style={styles.section}>
        ...
        <View style={styles.detailCard}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>Caregiver</Text>
          </View>
        </View>

        <TouchableOpacity
          style={styles.editButton}
          onPress={() => navigation.navigate(CaregiverScreens.EDIT_PROFILE)}
